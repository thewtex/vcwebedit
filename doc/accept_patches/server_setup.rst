...
software stacks installations and configurations are provided here.  Easy setup
is possible with a Linux server on the `Rackspace OpenStack`_ or the `Amazon
EC2`_ cloud, for example.
